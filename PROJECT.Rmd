...
=======
>>>>>>> 28d7212b2e0c3fe3ed4b47cb2f57d79e6ebdde3d
...
Leading_cause <- data %>%
  ...
  ggplot(aes(x = Cause.Name, y = `sum(Deaths)`)) + geom_col()

Leading_cause
```
---

##** How has Heart Disease changed over time?**
...
HEART_DISEASE <- data %>% 
  ...
  ggplot(aes(x = Year, y = TOTAL)) + geom_point() + geom_line()
